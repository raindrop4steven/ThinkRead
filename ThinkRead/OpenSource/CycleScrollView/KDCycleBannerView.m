...
//    CGRect pageControlFrame = CGRectMake(0, 0, CGRectGetWidth(_scrollView.frame), 30);
    CGRect pageControlFrame = CGRectMake(CGRectGetWidth(_scrollView.frame)-CGRectGetWidth(_scrollView.frame)/3.0+10, CGRectGetHeight(_scrollView.frame)-30, CGRectGetWidth(_scrollView.frame)/3.0, 30);
...
- (void)loadData {
    ...
    CGSize size = [_pageControl sizeForNumberOfPages:_datasourceImages.count];
    _pageControl.frame = CGRectMake(CGRectGetWidth(_scrollView.frame)-size.width-10, CGRectGetHeight(_scrollView.frame)-size.height, size.width, size.height);
